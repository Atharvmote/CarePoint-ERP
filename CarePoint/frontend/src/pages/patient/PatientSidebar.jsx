...
function PatientSidebar() {
  ...
  const menuItems = [
    ...
    { id: 'doctors', label: 'Find Doctors', icon: Users, path: '/patient/doctors' },
    { id: 'book-appointment', label: 'Book Appointment', icon: Calendar, path: '/patient/book-appointment' },
    { id: 'appointments', label: 'My Appointments', icon: FileText, path: '/patient/appointments' },
  ];
